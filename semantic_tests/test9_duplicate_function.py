# Breaks: DUPLICATE_FUNCTION — `def read()` is defined twice at module level.
# Expected: [DUPLICATE_FUNCTION] app.py @line 26 — function 'read' is defined more than once
# The second `def read(): return PRODUCTS` keeps generation intact (no cascade errors).
